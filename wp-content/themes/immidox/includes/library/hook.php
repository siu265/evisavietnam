 ...
 */
//immigro_load_default_hooks
function immigro_load_default_hooks() {

	$config = immigro_WSH()->config( 'default' );
...
/**
 * [immigro_main_header_area description]
 *
 * @return [type] [description]
 */

//immigro_main_header_area
function immigro_main_header_area() {
	...
	//need to change
	if ( $header == 'header_v1' ) {
		immigro_template_load( 'templates/header/default-header.php' );
	} elseif ( $header == 'header_v2' ) {
		immigro_template_load( 'templates/header/header_v2.php' );
	} elseif ( $header == 'header_v3' ) {
		immigro_template_load( 'templates/header/header_v3.php' );
	} elseif ( $header == 'header_v4' ) {
		immigro_template_load( 'templates/header/header_v4.php' );
	} elseif ( $header == 'header_v5' ) {
		immigro_template_load( 'templates/header/header_v5.php' );
	} else {
		immigro_template_load( 'templates/header/default-header.php' );
	}
}
...
/**
 * [immigro_main_footer_area description]
 *
 * @return [type] [description]
 */
//immigro_main_footer_area
function immigro_main_footer_area() {
	...
	//need to change
	if ( $footer == 'footer_v1' ) {
		immigro_template_load( 'templates/footer/default-footer.php' );
	} elseif ( $footer == 'footer_v2' ) {
		immigro_template_load( 'templates/footer/footer_v2.php' );
	} else {
		immigro_template_load( 'templates/footer/default-footer.php' );
	}
}
...
/**
 * [immigro_sidebar description]
 *
 * @return [type] [description]
 */
//immigro_sidebar
function immigro_sidebar( $data ) {

	immigro_template_load( 'templates/sidebar.php', compact( 'data' ) );
}

/**
 * [immigro_banner description]
 *
 * @return [type] [description]
 */
//immigro_banner
function immigro_banner( $data ) {

	immigro_template_load( 'templates/banner/banner.php', compact( 'data' ) );
