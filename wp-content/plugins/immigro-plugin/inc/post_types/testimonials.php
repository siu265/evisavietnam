...
namespace IMMIGROPLUGIN\Inc\Post_Types;

use IMMIGROPLUGIN\Inc\Abstracts\Post_Type;
 ...
 *
 * @version  2.6.0
 * @package  IMMIGROPLUGIN/Abstracts
 * @category Abstract Class
 * @author   Wptech
 */
class Testimonials extends Post_Type {

	protected $post_type = 'immigro_testimonials';
	...
	public static function init() {
		...
		self::instance()->singular  = esc_html__( 'Testimonial', 'wpimmigro' );
		self::instance()->plural    = esc_html__( 'Testimonials', 'wpimmigro' );
