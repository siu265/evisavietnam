 ...
 * @since 1.0.0
 */
class Banner_With_Left_Text extends Widget_Base {
	...
	public function get_name() {
		return 'immigro_banner_with_left_text';
	}
	...
	public function get_title() {
		return esc_html__( 'Banner With Left Text', 'immigro' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Banner With Left Text', 'immigro' ),
			]
		);
		$this->add_control(
			'sec_class',
