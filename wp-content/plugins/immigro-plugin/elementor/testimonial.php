...
class Testimonial extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Testimonial', 'immigro' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'testimonial',
			[
				'label' => esc_html__( 'Testimonial', 'immigro' ),
			]
		);
		$this->add_control(
			'sec_class',
					...
					[
						...
						'fields' => 
							[	
									...
									[
										'name' => 'block_text1',
										'label' => esc_html__('Rating Icon', 'rashid'),
										'type' => Controls_Manager::TEXTAREA,
										'default' => esc_html__('', 'rashid')
									],
                    ...
                    <div class="testimonial-block-one">
                        <div class="inner-box">
                            ...
                            <div class="text">
                                ...
                                <span class="date"><?php echo wp_kses($item['block_subtitle'], $allowed_tags);?></span>
