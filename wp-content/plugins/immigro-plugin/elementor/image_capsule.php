 ...
 * @since 1.0.0
 */
class Image_Capsule extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Image Capsule', 'immigro' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'image_capsule',
			[
				'label' => esc_html__( 'image Capsule', 'immigro' ),
			]
		);
		$this->add_control(
			'sec_class',
		...
		$this->add_control(
			'bgimg1',
			[
				'label' => esc_html__('Shape image', 'rashid'),
				'type' => Controls_Manager::MEDIA,
				'default' => ['url' => Utils::get_placeholder_image_src(),],
			]
		);	
	...
	protected function render() {
		...
		<section class="about-section p_relative pt_60 <?php echo esc_attr($settings['sec_class']);?>">
