...
class Tab extends Widget_Base {
	...
	protected function render() {
        ...
        <section class="country-style-three p_relative p-0">
            <div class="auto-container">
                <div class="tabs-box">
                    <div class="tab-btn-box p_relative d_block centred mb_40">
