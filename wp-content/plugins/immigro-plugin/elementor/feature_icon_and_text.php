 ...
 * @since 1.0.0
 */
class Feature_Icon_And_Text extends Widget_Base {
	...
	public function get_name() {
		return 'immigro_feature_icon_and_text';
	}
	...
	public function get_title() {
		return esc_html__( 'Feature Icon And Text', 'immigro' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Feature Icon And Text', 'immigro' ),
			]
		);
		$this->add_control(
			'sec_class',
