...
= 1.1.3 =
Security fix: Fixed unauthorized order status modification vulnerability. Improved hash verification to include secret key. Removed insecure public callback endpoint. Added proper validation and error handling.
