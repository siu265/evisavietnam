...
if ( ! class_exists( 'PB_Settings' ) ) {
 ...
 <style>
		...
		function generate_datepicker( $option ) {
			...
			wp_enqueue_style('jquery-ui', SLIDERPATH_PLUGIN_URL . 'assets/jquery-ui.css');
		...
		function generate_timepicker( $option ) {
			...
			wp_enqueue_style('jquery-ui-timepicker', SLIDERPATH_PLUGIN_URL . '/assets/jquery.timepicker.min.css');
            wp_enqueue_script('jquery-ui-timepicker', SLIDERPATH_PLUGIN_URL . '/assets/jquery.timepicker.min.js', array('jquery'));
